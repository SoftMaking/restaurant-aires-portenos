            ...
            <div class="container mx-auto px-8 md:px-24">
                ...
                <ul class="text-left list-none">
                    <li class="mb-6">
                        ...
                        <p class="mx-3 my-1"><a href="tel:+56995791409" class="font-light">+56 9 9579 1409</a></p>
                    </li>
                    <li class="mb-6">
                        <h4 class="font-medium text-lg my-3 text-light flex items-center"><svg width="20" height="18"
                    ...
                    <li class="mb-6">
                        ...
                        <p class="mx-3 font-light">Atendemos de lunes a sábados desde las 12:00 a 17:30 horas.</p>
                    </li>
                    <li class="mb-6">
